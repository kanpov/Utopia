...
import com.redgrapefruit.cryonic.EDIBLE_1
import com.redgrapefruit.cryonic.EDIBLE_3
import com.redgrapefruit.cryonic.YUCK
...
object PatchRegistry : IRegistry {
    override fun run() {
        ...
        moduleSpecific(Module.REALISM) {
            ...
            configureFood("trifle", "croptopia", FoodRegistry.OVERDUE_TRIFLE)
            configureFood("tuna_sandwich", "croptopia", FoodRegistry.OVERDUE_TUNA_SANDWICH)
            configureFood("turmeric", "croptopia", FoodRegistry.OVERDUE_TURMERIC)
            configureFood("turnip", "croptopia", FoodRegistry.OVERDUE_TURNIP)
            configureFood("vanilla", "croptopia", FoodRegistry.OVERDUE_VANILLA)
            configureFood("vanilla_ice_cream", "croptopia", FoodRegistry.OVERDUE_VANILLA_ICE_CREAM)
            configureFood("veggie_salad", "croptopia", FoodRegistry.OVERDUE_VEGGIE_SALAD)
            configureFood("walnut", "croptopia", FoodRegistry.OVERDUE_WALNUT)
            configureFood("whipping_cream", "croptopia", FoodRegistry.OVERDUE_WHIPPING_CREAM)
            configureFood("yam", "croptopia", FoodRegistry.OVERDUE_YAM)
            configureFood("yoghurt", "croptopia", FoodRegistry.OVERDUE_YOGHURT)
            configureFood("zucchini", "croptopia", FoodRegistry.OVERDUE_ZUCCHINI)
            ...
            configureDrink("yam_jam", "croptopia", DrinkRegistry.RANCID_YAM_JAM)
        }
    }
}