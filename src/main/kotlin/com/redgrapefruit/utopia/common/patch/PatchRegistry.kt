...
//        patch("paprika", "croptopia", ConfigRegistry.PAPRIKA, ItemRegistry.OVERDUE_PAPRIKA)
//        patch("peach", "croptopia", ConfigRegistry.PEACH, ItemRegistry.OVERDUE_PEACH)
//        patch("peach_jam", "croptopia", ConfigRegistry.PEACH_JAM, ItemRegistry.OVERDUE_PEACH_JAM)
//        patch("peanut", "croptopia", ConfigRegistry.PEANUT, ItemRegistry.OVERDUE_PEANUT)
//        patch("peanut_butter_and_jam", "croptopia", ConfigRegistry.PEANUT_BUTTER_AND_JAM, ItemRegistry.OVERDUE_PEANUT_BUTTER_AND_JAM)
//        patch("pear", "croptopia", ConfigRegistry.PEAR, ItemRegistry.OVERDUE_PEAR)
//        patch("pecan", "croptopia", ConfigRegistry.PECAN, ItemRegistry.OVERDUE_PECAN)
//        patch("pecan_ice_cream", "croptopia", ConfigRegistry.PECAN_ICE_CREAM, ItemRegistry.OVERDUE_PECAN_ICE_CREAM)
//        patch("pecan_pie", "croptopia", ConfigRegistry.PECAN_PIE, ItemRegistry.OVERDUE_PECAN_PIE)
//        patch("pepper", "croptopia", ConfigRegistry.PEPPER, ItemRegistry.OVERDUE_PEPPER)
//        patch("pepperoni", "croptopia", ConfigRegistry.PEPPERONI, ItemRegistry.OVERDUE_PEPPERONI)
//        patch("persimmon", "croptopia", ConfigRegistry.PERSIMMON, ItemRegistry.OVERDUE_PERSIMMON)
//        patch("pineapple", "croptopia", ConfigRegistry.PINEAPPLE, ItemRegistry.OVERDUE_PINEAPPLE)
//        patch("pineapple_juice", "croptopia", ConfigRegistry.PINEAPPLE_JUICE, ItemRegistry.OVERDUE_PINEAPPLE_JUICE)
//        patch("pineapple_pepperoni_pizza", "croptopia", ConfigRegistry.PINEAPPLE_PEPPERONI_PIZZA, ItemRegistry.OVERDUE_PINEAPPLE_PEPPERONI_PIZZA)
//        patch("pizza", "croptopia", ConfigRegistry.PIZZA, ItemRegistry.OVERDUE_PIZZA)
...
//        patch("potato_chips", "croptopia", ConfigRegistry.POTATO_CHIPS, ItemRegistry.OVERDUE_POTATO_CHIPS)
