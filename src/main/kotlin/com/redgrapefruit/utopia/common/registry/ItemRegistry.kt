...
object ItemRegistry {
    ...
    val OVERDUE_LETTUCE = OverdueFoodItem(ConfigRegistry.LETTUCE)
    val OVERDUE_LIME = OverdueFoodItem(ConfigRegistry.LIME)
    val OVERDUE_LIMEADE = OverdueFoodItem(ConfigRegistry.LIMEADE)
    val OVERDUE_MANGO = OverdueFoodItem(ConfigRegistry.MANGO)
    val OVERDUE_MANGO_ICE_CREAM = OverdueFoodItem(ConfigRegistry.MANGO_ICE_CREAM)
    val OVERDUE_MEAD = OverdueFoodItem(ConfigRegistry.MEAD)
    val OVERDUE_MELON_JUICE = OverdueFoodItem(ConfigRegistry.MELON_JUICE)
    val OVERDUE_MILK_BOTTLE = OverdueFoodItem(ConfigRegistry.MILK_BOTTLE)
    val OVERDUE_MOLASSES = OverdueFoodItem(ConfigRegistry.MOLASSES)
    val OVERDUE_MUSTARD = OverdueFoodItem(ConfigRegistry.MUSTARD)
    val OVERDUE_NECTARINE = OverdueFoodItem(ConfigRegistry.NECTARINE)
    val OVERDUE_NOODLE = OverdueFoodItem(ConfigRegistry.NOODLE)
    ...
    val OVERDUE_OATMEAL = OverdueFoodItem(ConfigRegistry.OATMEAL)
    val OVERDUE_OLIVE = OverdueFoodItem(ConfigRegistry.OLIVE)
    val OVERDUE_OLIVE_OIL = OverdueFoodItem(ConfigRegistry.OLIVE_OIL)
    val OVERDUE_ONION = OverdueFoodItem(ConfigRegistry.ONION)
    val OVERDUE_ONION_RINGS = OverdueFoodItem(ConfigRegistry.ONION_RINGS)
    val OVERDUE_ORANGE = OverdueFoodItem(ConfigRegistry.ORANGE)
    val OVERDUE_ORANGE_JUICE = OverdueFoodItem(ConfigRegistry.ORANGE_JUICE)
    val OVERDUE_PAPRIKA = OverdueFoodItem(ConfigRegistry.PAPRIKA)
    val OVERDUE_PEACH = OverdueFoodItem(ConfigRegistry.PEACH)
    val OVERDUE_PEACH_JAM = OverdueFoodItem(ConfigRegistry.PEACH_JAM)
    val OVERDUE_PEANUT = OverdueFoodItem(ConfigRegistry.PEANUT)
    val OVERDUE_PEANUT_BUTTER_AND_JAM = OverdueFoodItem(ConfigRegistry.PEANUT_BUTTER_AND_JAM)
    val OVERDUE_PEAR = OverdueFoodItem(ConfigRegistry.PEAR)
    val OVERDUE_PECAN = OverdueFoodItem(ConfigRegistry.PECAN)
    val OVERDUE_PECAN_ICE_CREAM = OverdueFoodItem(ConfigRegistry.PECAN_ICE_CREAM)
    val OVERDUE_PECAN_PIE = OverdueFoodItem(ConfigRegistry.PECAN_PIE)
    ...
    val OVERDUE_PINEAPPLE_JUICE = OverdueFoodItem(ConfigRegistry.PINEAPPLE_JUICE)
    val OVERDUE_PINEAPPLE_PEPPERONI_PIZZA = OverdueFoodItem(ConfigRegistry.PINEAPPLE_PEPPERONI_PIZZA)
    val OVERDUE_PIZZA = OverdueFoodItem(ConfigRegistry.PIZZA)
    val OVERDUE_PLUM = OverdueFoodItem(ConfigRegistry.PLUM)
    val OVERDUE_POPCORN = OverdueFoodItem(ConfigRegistry.POPCORN)
    val OVERDUE_PORK_AND_BEANS = OverdueFoodItem(ConfigRegistry.PORK_AND_BEANS)
    ...
    val SALTED_OLIVE = SaltedFoodItem(ConfigRegistry.OLIVE)
    val SALTED_ONION_RINGS = SaltedFoodItem(ConfigRegistry.ONION_RINGS)
    val SALTED_PAPRIKA = SaltedFoodItem(ConfigRegistry.PAPRIKA)
    ...
    val SALTED_POPCORN = SaltedFoodItem(ConfigRegistry.POPCORN)
    val SALTED_POTATO_CHIPS = SaltedFoodItem(ConfigRegistry.POTATO_CHIPS)
    ...
    fun run(): Unit = moduleSpecific(Module.REALISM) {
        ...
        register("overdue_limeade", OVERDUE_LIMEADE)
        register("overdue_mango", OVERDUE_MANGO)
        register("overdue_mango_ice_cream", OVERDUE_MANGO_ICE_CREAM)
        register("overdue_melon_juice", OVERDUE_MELON_JUICE)
        register("overdue_milk_bottle", OVERDUE_MILK_BOTTLE)
        ...
        register("overdue_olive_oil", OVERDUE_OLIVE_OIL)
        ...
        register("overdue_orange_juice", OVERDUE_ORANGE_JUICE)
        register("overdue_paprika", OVERDUE_PAPRIKA)
        register("overdue_peach", OVERDUE_PEACH)
        register("overdue_peach_jam", OVERDUE_PEACH_JAM)
        ...
        register("overdue_pineapple_juice", OVERDUE_PINEAPPLE_JUICE)
